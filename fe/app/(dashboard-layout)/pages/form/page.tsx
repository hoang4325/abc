                ...
                <Popover open={open} onOpenChange={setOpen}>
                  <PopoverTrigger
                    ...
                    className={cn(
                      ...
                      'w-full justify-between font-normal hover:bg-transparent focus:border-primary'
                    )}>
                    <span suppressHydrationWarning>{date ? date.toLocaleDateString() : 'Select date'}</span>
                    <Icon
