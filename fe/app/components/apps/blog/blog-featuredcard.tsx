            ...
            <div>
              <div className="absolute w-full h-full left-0 p-6">
                <div className="flex flex-col h-full justify-between ">
                  ...
                  <div>
                    <h2 className="text-2xl text-white my-6 hover:underline">
                    ...
                    <div className="mt-4">
                      <Link
                        href={`/blogs/${post.id}`}
                        className="inline-flex items-center text-sm font-semibold text-white bg-primary/90 hover:bg-primary px-3 py-1.5 rounded-md transition-colors gap-1.5"
                      >
                        Xem bài viết &rarr;
                      </Link>
                    </div>
