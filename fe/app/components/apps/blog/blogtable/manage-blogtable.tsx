            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger
                  ...
                  className={cn(
                    ...
                    "h-8 w-8 hover:bg-primary/5 rounded-lg bg-background border border-border"
                  )}
                >
                  <Pen size={18} />
                </TooltipTrigger>
              ...
              <Tooltip>
                <TooltipTrigger
                  ...
                  className={cn(
                    buttonVariants({ variant: "link", size: "sm" }),
                    "h-8 w-8 text-destructive! rounded-lg bg-background border border-border hover:bg-destructive/5"
                  )}
                >
                  <Trash2 size={18} />
                </TooltipTrigger>
